    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((fastButton.isChecked()|normalButton.isChecked()|slowButton.isChecked())&(kindButton.isChecked()|sosoButton.isChecked()|badButton.isChecked())&
                    ...
                    rateState();
                    Intent intent = new Intent(ratingActivity.this, com.example.hibuyphotocard.BuyMainActivity.class); //시작 페이지, 이동할 페이지
        ...
        mypage.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                com.example.hibuyphotocard.ScoreList scoreList = snapshot.getValue(com.example.hibuyphotocard.ScoreList.class);
...
//                    }
    ...
    public void addScore(int delivery, int manner, int item){
        com.example.hibuyphotocard.ScoreList ScoreList = new com.example.hibuyphotocard.ScoreList(delivery, manner, item);
        //점수 저장 경로
        intent = getIntent();
        String nickName = intent.getStringExtra("userName");
