...
//
//public class SettingActivity_test extends Fragment {
//
...
//        viewGroup = (ViewGroup) inflater.inflate(R.layout.profilesetting,container,false);
//        return viewGroup;
//
//
...
//        });
//
//        nicknameText = viewGroup.findViewById(R.id.signup_nickname);
//
//        Intent intent = getIntent();
//        String email = intent.getStringExtra("emailtext");
//
//        group_label = viewGroup.findViewById(R.id.group_label);
//
...
//
//
//                            Intent intent = new Intent(SettingActivity_test.this, MainActivity.class);
...
//                ArrayAdapter groupAdapter = new ArrayAdapter(SettingActivity_test.this,
...
//                        }
//                        else{
//                            Toast.makeText(SettingActivity_test.this,
...
//                    ArrayAdapter memberAdapter = new ArrayAdapter(SettingActivity_test.this,
