...
public class TagDialogActivity extends Activity {
    ...
    public TagDialogActivity(Context context){
        searchDialog = new Dialog(context);
        searchDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        searchDialog.setContentView(R.layout.activity_tag_dialog);
        activityContext = context;
        dialogContext = searchDialog.getOwnerActivity();
    }

    public void showDialog(String imageFiile){
        searchDialog.show();
        ...
        yesBtn.setOnClickListener(new View.OnClickListener() { //다음 activity로 값 전송
            ...
            public void onClick(View v) {
                Intent intent = new Intent(searchDialog.getContext(), WritingActivity.class);
                intent.putExtra("groupTag",selectGroup);
                intent.putExtra("albumTag", selectAlbum);
                intent.putExtra("memberTag", selectMember);
